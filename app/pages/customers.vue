  ...
  return [
    ...
    },
    {
      ...
      onSelect() {
        ...
        toast.add({
          title: 'Copie dans le presse-papiers',
          description: 'L\'ID client a ete copie dans le presse-papiers'
        })
      }
    },
    {
    ...
    <template #body>
        ...
        <div class="flex flex-wrap items-center gap-1.5">
          ...
          <USelect
            ...
            :items="[
              ...
              { label: 'Abonne', value: 'subscribed' },
              { label: 'Desabonne', value: 'unsubscribed' },
              { label: 'Rejete', value: 'bounced' }
            ]"
      ...
      <div class="flex items-center justify-between gap-3 border-t border-default pt-4 mt-auto">
        <div class="text-sm text-muted">
          ...
          {{ table?.tableApi?.getFilteredRowModel().rows.length || 0 }} ligne(s) selectionnee(s).
        </div>
