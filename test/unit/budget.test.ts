...
describe('category constants', () => {
  ...
  it('has all expected income categories', () => {
    expect(INCOME_CATEGORIES).toContain('Aides sociales')
    expect(INCOME_CATEGORIES).toContain('Investissements')
    expect(INCOME_CATEGORIES).toContain('Primes')
    expect(INCOME_CATEGORIES).toContain('Remboursements')
    expect(INCOME_CATEGORIES).toContain('Vente')
    expect(INCOME_CATEGORIES).toContain('Autre')
  })

  it('has expense categories', () => {
    expect(EXPENSE_CATEGORIES).toContain('Loyer')
  ...
  it('has all expected expense categories', () => {
    expect(EXPENSE_CATEGORIES).toContain('Loyer')
    expect(EXPENSE_CATEGORIES).toContain('Charges')
    expect(EXPENSE_CATEGORIES).toContain('Énergie')
    expect(EXPENSE_CATEGORIES).toContain('Eau')
    expect(EXPENSE_CATEGORIES).toContain('Télécom')
    ...
    expect(EXPENSE_CATEGORIES).toContain('Restaurant')
    expect(EXPENSE_CATEGORIES).toContain('Santé')
    expect(EXPENSE_CATEGORIES).toContain('Enfants')
    expect(EXPENSE_CATEGORIES).toContain('Habillement')
    expect(EXPENSE_CATEGORIES).toContain('Loisirs')
    expect(EXPENSE_CATEGORIES).toContain('Éducation')
    expect(EXPENSE_CATEGORIES).toContain('Cadeaux')
    expect(EXPENSE_CATEGORIES).toContain('Épargne')
    expect(EXPENSE_CATEGORIES).toContain('Impôts')
